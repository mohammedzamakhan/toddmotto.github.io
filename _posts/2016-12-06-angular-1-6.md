...
After Angular 1.5 was released, the [component method](/exploring-the-angular-1-5-component-method/) has taken over. Now there are important changes to take note of when upgrading to Angular 1.6 - this post outlines some hints and tips as well as runs through some new features.
